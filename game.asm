...
.DATA
	...
	bomberManFilename DB "bomber.img", 0
...
; 0 , 1 , 2 , 3 , 4 are blocks which _label_explode_bomb1 in BOMB_LEVEL_1
; 0 , 1 , 2 , 3 , 4 , 5 , 6 , 7 , 8 are blocks which _label_explode_bomb1 in BOMB_LEVEL_2
;
;                x______
;                |     |
;                |  8  |
