...
MAIN PROC FAR
	...
	callOpenFile blockFilename,blockFilehandle
	callLoadData blockFilehandle,blockData,blockWidth,blockHeight
	callCloseFile blockFilehandle
